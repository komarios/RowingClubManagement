 ...
 * $RCSfile: DefaultRowingSessionTypeComparator.java,v $
...
public class DefaultRowingSessionTypeComparator
  ...
  private final static String base =
    DefaultRowingSessionTypeComparator.class.getName();
  ...
  private final static String makeKey( RowingSessionType rst ) {
    return makeKey( rst.getName() );
  }

  private final static Map ordinalMap = new HashMap();
  static {

    String key  = makeKey( RowingSessionType.NAME_PRACTICE );
    Integer val = new Integer( 1 );
    ordinalMap.put( key, val );

    key = makeKey( RowingSessionType.NAME_REGATTA );
    val = new Integer( 2 );
    ordinalMap.put( key, val );
  ...
  private final static Integer getOrdinal( RowingSessionType rst ) {
    return (Integer) ordinalMap.get( makeKey(rst) );
  }
  ...
  private final static Integer getOrdinal( Object o ) {
    ...
    if ( o instanceof RowingSessionType ) {
      retVal = getOrdinal( ((RowingSessionType) o) );
    }
   ...
   * @param o a non-null RowingSessionType or a String NAME of a level
   */
  public static int staticCompare( Object o1, Object o2 ) {
    ...
    if ( o1 == null || o2 == null ) {
      ...
      String err = "DefaultRowingSessionTypeComparator.staticCompare: " + msg;
      theLog.error( err );
...
/*
 * $Log: DefaultRowingSessionTypeComparator.java,v $
 * Revision 1.3  2003/02/26 03:38:45  rphall
 * Added copyright and GPL license
 *
 * Revision 1.2  2002/02/18 18:04:07  rphall
