...
public class AllTestsLog4jConfig {
  ...
  public static Test suite() {
    ...
    //System.out.println("building member.AllTestsLog4jConfig ...");
    TestSuite suite = new TestSuite(
        "All tests for test.clra.member plus log4j configuration" );

    //System.out.println("adding Log4jConfigurator ...");
    suite.addTest( new TestSuite(Log4jConfigurator.class) );

    //System.out.println("adding member.AllTests ...");
    suite.addTest( AllTests.suite() );

    //System.out.println("finished building member.AlltestsLog4jConfig");
    return suite;
  }
