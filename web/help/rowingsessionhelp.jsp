 ...
 * $RCSfile: rowingsessionhelp.jsp,v $
...
<head>
<title><bean:message key="helpsession.title"/></title>
<html:base/>
...
<td width=322 align=right>
  <html:link page="/admin/rowingsession.jsp">
...
<td width=1>&nbsp;</td>
<td width=322 align=left>
  <p><FONT class=header16><bean:message key="helpsession.pagetitle"/></FONT></p></td>
<td width=1>&nbsp;</td>
...
<td width=1>&nbsp;</td>
<td colspan=3>
<FONT class=header16><bean:message key="helpsession.pagesubtitle"/></FONT>
<td width=1>&nbsp;</td>
</td>
</tr>
...
<bean:message key="helpsession.shortdesc" arg0='<%=thisDate.getValue()%>'/>
</p>
</td>
<td width=1>&nbsp;</td>
</td>
...
<td width=1>&nbsp;</td>
<td colspan=3>
<p><bean:message key="helpsession.longdesc" /></p>
<ol>
  <li><bean:message key="helpsession.createdesc"/></li><p></p>
  <li><bean:message key="helpsession.publishdesc"/></li><p></p>
  <li><bean:message key="helpsession.lockdesc"/></li><p></p>
  <li><bean:message key="helpsession.scheduleddesc"/></li><p></p>
  <li><bean:message key="helpsession.completedesc"/></li><p></p>
  <li><bean:message key="helpsession.closedesc"/></li><p></p>
</ol>
</p>
<p><bean:message key="helpsession.longdesc2" /></p>
</td>
<td width=1>&nbsp;</td>
</td>
</tr>
