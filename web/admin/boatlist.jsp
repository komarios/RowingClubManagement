...
<%@ page language= "java" %>
<%@ page import= "com.clra.web.BoatSet" %>
<%@ page import= "com.clra.rowing.BoatView" %>
...
<p> <FONT class=header16>Set up boats</FONT> &nbsp; </p> 

<p>This page shows the boats used by the club.</p>

<p>You may add a new boat by clicking on "Add".<p>

<p>You may modify the status of a boat, or attach a note to it, by clicking on that boat.
</p>

<p><FONT class=header16>BOATS</FONT></p>

<!-- BOAT TABLE -->
<TABLE cellpadding=0 cellspacing=0 border=0 width=647>

<!-- HEADER OF BOAT TABLE -->
<TR>
...
<!-- END HEADER -->
    ...
    <!-- BOAT ITERATION -->
    <%
    BoatSet list = BoatSet.findAllActiveBoats();
    ...
    <%
    while ( iter.hasNext() ) {
      BoatView bv = (BoatView) iter.next();
    %>
      <tr>
